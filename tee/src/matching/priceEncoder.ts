 ...
 */
export function encodePriceAsk(price: number): string {
  validatePrice(price);
 ...
 */
export function decodePriceAsk(encoded: string): number {
 ...
 */
export function encodePriceBid(price: number): string {
  validatePrice(price);
 ...
 */
export function decodePriceBid(encoded: string): number {
  const value = parseInt(encoded, 10);
 ...
 */
export function encodePrice(price: number, side: 'bid' | 'ask'): string {
 ...
 */
export function decodePrice(encoded: string, side: 'bid' | 'ask'): number {
 ...
 */
export function orderSideToKeyString(side: OrderSide): 'bid' | 'ask' {
 ...
 */
export function keySideToOrderSide(side: 'bid' | 'ask'): OrderSide {
 ...
 */
export function decodeOrderKey(key: string): OrderKeyComponents {
 ...
 */
export function getOrderKeyPrefix(marketId: Hex, outcomeIndex: number, side: 'bid' | 'ask'): string {
 ...
 */
export function encodeBalanceKey(userId: string): string {
 ...
 */
export function decodeBalanceKey(key: string): string {
  const parts = key.split(':');
 ...
 */
export function encodePositionKey(
  userId: string,
  marketId: Hex,
  outcomeIndex: number
): string {
 ...
 */
export function decodePositionKey(key: string): {
  userId: string;
  marketId: Hex;
  outcomeIndex: number;
} {
 ...
 */
export function getUserPositionsPrefix(userId: string): string {
 ...
 */
export function getMarketPositionsPrefix(marketId: Hex): string {
 ...
 */
export function decodeMetaKey(fullKey: string): string {
