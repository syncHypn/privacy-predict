 ...
 */
export function boxEncrypt(message, recipientPublicKey, senderSecretKey) {
 ...
 */
export function boxDecrypt(encryptedWithNonce, senderPublicKey, recipientSecretKey) {
 ...
 * @returns Encrypted data with nonce prepended
 */
export function secretBoxEncrypt(message, key) {
 ...
 * @returns Decrypted data
 */
export function secretBoxDecrypt(encryptedWithNonce, key) {
 ...
 */
export function deserializeOrderPayload(data) {
    try {
 ...
 */
export function encryptOrderForTEE(payload, teePublicKey, userSecretKey) {
 ...
 */
export function decryptOrderInTEE(encryptedBase64, userPublicKey, teeSecretKey) {
 ...
 */
export function encryptResponseForUser(data, userPublicKey, teeSecretKey) {
